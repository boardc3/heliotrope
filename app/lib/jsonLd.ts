    ...
    "@graph": [
      {
        ...
        headline: "Two connected Corona del Mar condos — sold separately — one block from village dining.",
        description:
          "A refreshed cinematic showcase for 437 Heliotrope Avenue: two connected condos sold separately on a 3,540-square-foot Corona del Mar lot, with five bedrooms, six bathrooms (four full and two powder rooms), 3,119 square feet of combined habitable area, and a completed buyer package.",
      ...
      },
      {
        ...
        name: SHORT_ADDRESS,
        url: siteUrl,
        numberOfAccommodationUnits: 2,
        numberOfBedrooms: PROPERTY.bedrooms,
        numberOfBathroomsTotal: PROPERTY.bathrooms,
        floorSize: { "@type": "QuantitativeValue", value: PROPERTY.habitableArea, unitText: "SQFT" },
        lotSize: { "@type": "QuantitativeValue", value: PROPERTY.lotSqFt, unitText: "SQFT" },
        amenityFeature: [
          "Two connected condos",
          "Sold separately",
          "Unit A front residence",
          "Unit B rear carriage-style condo",
          "Village walkability",
          "Coastal proximity",
